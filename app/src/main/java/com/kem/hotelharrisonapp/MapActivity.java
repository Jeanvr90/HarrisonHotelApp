...
public class MapActivity extends AppCompatActivity implements OnMapReadyCallback, MapboxMap.OnMapClickListener, PermissionsListener {
    ...
    private static final LatLng locationOne = new LatLng(34.239838, -118.430511);
    private static final LatLng locationTwo = new LatLng(33.774982, -118.176532);
...
// Adding in LocationComponentOptions is also an optional parameter
            ...
            findViewById(R.id.back_to_camera_tracking_mode).setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    Toast.makeText(MapActivity.this, "Ubicacion Exacta",
    ...
    private void addMarkerIconsToMap(Style loadedMapStyle) {
        loadedMapStyle.addImage("icon-id", BitmapUtils.getBitmapFromDrawable(
                getResources().getDrawable(R.drawable.ic_harrinson)));
